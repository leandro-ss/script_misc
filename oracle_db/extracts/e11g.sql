...
prompt *                                                                              *
prompt *  Versão 1.7.1 - Inmetrics 2015                                               *
prompt *                                                                              *
prompt ********************************************************************************
prompt
prompt ********************************************************************************
...
prompt *  1.7.2   *  23/02/2016  *  Leandro Sampaio  *  Valor Default para Data       *
prompt ********************************************************************************
prompt
pause Pressione enter para continuar

ACCEPT ScriptInstance PROMPT '   Instância da Base : '
ACCEPT ScriptUser     PROMPT '   Usuário           : ' DEFAULT 'scapacity01'
ACCEPT ScriptPasswd   PROMPT '   Senha             : ' HIDE DEFAULT 'inmtim#0912'
prompt
...
variable date_mask_default varchar2(10) 
...
exec select 'dd/mm/yyyy'                                                                                                                               into :date_mask_default from dual;
ACCEPT date_mask  PROMPT '*  Novo valor : ' DEFAULT :date_mask_default
prompt *                                                                              *
prompt *  Data de início                                      (com aspas simples '')  *
prompt *  Valor default: 'sysdate -20 dias'          (deixar em branco para aceitar)  *
...
prompt *  Valor default: 'sysdate  -1 dias'          (deixar em branco para aceitar)  *
...
select 'METRIC_DATE;INSTANCE;METRIC_NAME;MIN_VAL;P01_VAL;P05_VAL;P10_VAL;AVG_VAL;P90_VAL;P95_VAL;P99_VAL;MAX_VAL;MIN_STDDEV;AVG_STDDEV;MAX_STDDEV' extraction from dual
union all
select * from (
