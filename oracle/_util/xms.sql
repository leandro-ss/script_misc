...
column xms_plan_step                heading Operation for a45
column xms_object_name              heading Object|Name for a40
...
--    p.child_number                  xms_child_number, (thiago)
--        ps.child_number,
...
--    ps.last_disk_writes             xms_last_disk_writes, (thiago)
    p.cost                          xms_opt_cost
...
Comandos para verificar query. Melhor que autotrace.
