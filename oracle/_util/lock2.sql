...
col type_desc format a50 wrap

SELECT /*+ FIRST_ROWS ORDERED */ 
decode(block,0,'NOT BLOCKING',1,'BLOCKING') BLOCKING,
decode(request,0,'0','BLOCKED') request,
l.lmode lmode ,
id1,
id2,
username,
...
s.osuser osuser , s.sid sid , s.serial# serial,
decode(l.type,
